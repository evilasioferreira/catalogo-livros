      ...
      books.forEach(book => {
          ...
          bookCard.innerHTML = `
              ...
              <div class="p-4">
                  ...
                  <button class="remove-book-btn mt-2 text-red-500">Remove</button>
              </div>
          `;
          bookCard.querySelector('.remove-book-btn').addEventListener('click', (e) => {
              e.stopPropagation(); // Prevent triggering bookCard click event
              removeBook(book.id);
          });
